    ...
    <footer className="pt-32 pb-20 px-6 border-t border-neutral-100 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-5xl md:text-5xl font-bold mb-8 transition-colors hover:text-brand-blue cursor-default text-brand-dark">
              Let's build the <br />future system.
            </h2>
            <p className="text-lg text-brand-gray mb-10 max-w-md font-sans">
              Currently open for leadership roles in UI Engineering and Design Systems.
            </p>
            <div className="flex flex-col gap-6 font-sans">
              <a
                href="mailto:akshithamekala04@gmail.com"
                className="text-xl md:text-lg font-bold hover:text-brand-blue transition-colors underline decoration-brand-blue/20 text-brand-dark"
              >
...
>
  RESUME
          ...
          <div className="bg-neutral-50 p-6 rounded-[3rem] border border-neutral-200">
            <h4 className="text-xl font-bold mb-8 text-brand-dark">Send a Quick Brief</h4>
            <form className="space-y-2" onSubmit={(e) => e.preventDefault()}>
              ...
              <button className="w-full py-3 bg-brand-blue text-white rounded-xl font-bold shadow-lg shadow-brand-blue/20 hover:opacity-90 transition-all cursor-pointer">
                Submit Request
              </button>
            </form>
          </div>
